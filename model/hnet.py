...
class MobileFaceNet(nn.Module):
    def __init__(self, feature_dim=128, bottleneck_setting=MobileFaceNet_BottleNeck_Setting):
        ...
        self.conv1 = ConvBlock(1, 64, 3, 1, 1)
        ...
        self.feature_linear = nn.Linear(4096, feature_dim)
...
class SigMobileNet(nn.Module):
    def __init__(self, feature_dim):
        super(SigMobileNet, self).__init__()
        self.feature_extractor = MobileFaceNet(feature_dim=feature_dim)
...
if __name__ == "__main__":
    input = torch.Tensor(2, 1, 150, 220)
    input2 = torch.Tensor(2, 1, 150, 220)
    net = SigMobileNet(feature_dim=128)
    print(net)
